...
const textMutedColor = Color(0xFFAAAAAA);
...
const appColorPrimary = Color(0xFF0A1C49);
const appColorAccent = Color(0xFFFDE42D);
...
const food_colorPrimary = Color(0xFF1d1d1b);
